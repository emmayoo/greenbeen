	...
	<input type="hidden" value="${id}" id="hidden">
		...
		<jsp:include page="../top.jsp"></jsp:include>
         ...
         <ul class="nav nav-tabs" role="tablist">
         	...
         	<li role="presentation"><a class="dropdown-item" href="#" id="purpose" aria-controls="profile" role="tab" data-toggle="tab">목적</a></li>
          	<li role="presentation" class="active"><a class="dropdown-item"href="#" id="procedure" aria-controls="messages" role="tab" data-toggle="tab">조사 및 공개절차</a></li>
